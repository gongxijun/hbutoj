...
public class MailAction extends ActionSupport {
    ...
    public String queryRecvMails() throws Exception {
        try {
            ...
            sql = "select count(m.mail_id) from Mail m where m.defunct='N' and m.to_user='"
                    + username_ + "'";
    ...
    public String showMail() throws Exception {
        try {
            ...
            // System.out.println(username_+" " + mail.getTo_user()+ " "
            // +mail.getFrom_user()+" "+mail.getIsnew());
            if (mail.getTo_user().equals(username_)
                    || mail.getFrom_user().equals(username_)) {
                if (mail.getTo_user().equals(username_)
                        && mail.getIsnew().equals(1)) {
