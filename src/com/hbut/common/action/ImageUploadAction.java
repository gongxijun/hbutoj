...
public class ImageUploadAction extends ActionSupport {
    ...
    public String uploadImage() throws Exception {
        ...
        String serverPath = ServletActionContext.getRequest().getRealPath(
                "/upload");
        // 页面的引用地址
        String savePath = "/upload/";
        // 实际应用中鉴于地址的可变性，此处的两个path可以动态生成或从配置文件读取

        kEUploadImage(ServletActionContext.getRequest(),
                ServletActionContext.getResponse(), imgFile, imgTitle,
                imgWidth, imgHeight, imgN, savePath, serverPath);

        return null;
    }

    void kEUploadImage(HttpServletRequest request,
                       HttpServletResponse response, File imgFile, String imgTitle,
                       String imgWidth, String imgHeight, String imgName, String savePath,
                       String serverPath) throws FileNotFoundException, IOException {
    ...
    PrintWriter encodehead(HttpServletRequest request,
