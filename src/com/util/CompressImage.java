...
public class CompressImage {
	 ...
	 *            　新文件的主文件名
	 * @param maxBorder
	 *            　新文件的长度和宽度里面最长的边的长度，按比例缩小另外的一个边,比如要生成
	 *            的图形最长的边是64像素，如果是长度比宽度大，那么，生成的长度是64，而宽度就是原始的宽度的等比例缩小的尺寸。
	 */

	public static void Generate(String oldPath, String newDir,
			String newMainName, int maxBorder) {
		...
		try {
			...
			desImage.getGraphics().drawImage(souImage, 0, 0, newWidth,
					newHeight, null);
