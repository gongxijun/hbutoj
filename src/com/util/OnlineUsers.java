...
public class OnlineUsers {
    ...
    private static Map<String, OnlineUserBean> map_online_users = Collections
            .synchronizedMap(new HashMap<String, OnlineUserBean>());
    ...
    public static Map<String, OnlineUserBean> getOnlineUsers() {
		 ...
		 * map_online_users.get(s).getLoginDate().toString() + "  " +
