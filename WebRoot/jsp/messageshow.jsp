...
<span class="link_author" style="color:grey;"><a href="profile/<s:property value="messagebean.author"/>"
                                                 class="user-tip"
                                                 user="<s:property value="messagebean.author"/>"><s:property
        value="messagebean.author"/></a>  &nbsp;<s:text name="post"/><span
        title="<s:date name="messagebean.in_date" nice="false" format="yyyy-MM-dd HH:mm:ss"/>"><s:property
        value="messagebean.friendly_Date"/></span>
</span>

                <span class="link_view" title="<s:text name="topic.views"/>"><s:property
                        value="messagebean.views"/> <s:text name="topic.views"/></span>
                <span class="link_comments" title="<s:text name="topic.reply"/>"><s:text
                        name="topic.reply"/>(<s:property value="messagebean.comments"/>)</span>
<span class="link_edit">
<s:if test="#session.session_username==messagebean.author"><a
        href="topic/edit/<s:property value="messagebean.messageId"/>">Eidt</a></s:if>
</span>
            </div>
            <div class="content">
                <blockquote>
...
<s:iterator value="tagsList" status="tagsst">
	...
	<span class="topic-vote">	
		...
		<a href="#" class="topic-vote-down-<s:property value="messagebean.messageId"/>"><img
                style="vertical-align:middle;position:relative;top:-0.2em;" src="img/vote/votedown.png"
                alt="Vote: I do not like it" title="Vote: I do not like it"/></a>
                ...
                <div class=" roundbox">
                    ...
                    <div class="comments">
                        <ul id="ul-comments" style="">
                            ...
                            <div style="height:1px;margin-bottom:10px;padding-bottom:10px;border-bottom:1px dashed #ddd;"></div>
                            </s:if>
                            <li>
                                <s:if test="nodeID[#st.index]!=''">
                                <div id=mc_<s:property value="message_id"/> class="comment">

                                    <span style="float:left; width:40px;"><a href="profile/<s:property value="author"/>"
                                                                             class="user-tip"
                                    ...
                                    <div style="margin-left:50px;">
                                        <a href="profile/<s:property value="author"/>"
                                           name="rpl_<s:property value="messageId"/>"><s:property value="author"/></a>
                                        <span style="color:grey"><s:text name="post"/> <s:date name="in_date"
                                                                                               nice="false"
...
<a href="#" class="vote-for-comment" voteDirection="1" dd="x"><img style="position:relative;top:3px;opacity:0.55;"
                                                                   src="img/vote/comment-voteup.png"
                                                                   alt="Vote: I like it" title="Vote: I like it"/></a>
&nbsp;
<s:if test="votes>0">
<span style="color:green;font-weight:bold;">
...
<a href="#" class="vote-for-comment" voteDirection="-1" dd="y"><img style="position:relative;top:2px;opacity:0.55;"
                                        ...
                                        <div id="inline_reply_of_<s:property value='messageId'/>_<s:property value='rootId'/>"
                    ...
                    <div class="comment reply-edit-box reply-edit-box-pro" style="position: relative;padding: 6px;">
                        <form action="" method="post">
                            ...
                            <div style="text-align:left;margin-bottom: 6px;">
                                <textarea class="message-content" id="reply-content" name="content"
                                          rows="10"></textarea>
                            </div>
