...
<head>
    <base href="<%=basePath%>">
    <title>Topi-HBUT Online Judge</title>
                    ...
                    <s:iterator value="messages" status="st">
                        <tr <s:if test="#st.odd">class="dark"</s:if>>
                            <td class="title left-item">
                                <s:if test="orderNum>0"><span style="color:red;">[<s:text
                                        name="topic.top"/>]</span></s:if>
                            ...
                            <td class="coder">
                                <b><a href="profile/<s:property value="create_user"/>" class="user-tip"
                                      user="<s:property value="create_user"/>"><s:property value="create_user"/></a></b>
                            </td>
                            <td class="date">
        ...
        <div style="margin:0 12px;font-size:15px;">
            ...
            <div class="right">
                ...
                <s:if test="page < pageCount">
                    <a href="t/page/<s:property value="page+1"/>"
