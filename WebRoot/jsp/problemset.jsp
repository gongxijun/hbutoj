...
<head>
    <base href="<%=basePath%>">
    <title>Problem Set - HBUT Online Judge</title>
                    ...
                    <s:iterator value="problemList" status="st">
                        <tr <s:if test="#st.odd">class="dark"</s:if>>
                            <td class="id left-item "><a
                                    href="problemset/problem/<s:property value="problem_id"/>"><s:property
                                    value="problem_id"/></a></td>
                            <td class="title">
                            ...
                            <td class="solved">
                                <a href="problemset/status/problem/<s:property value="problem_id"/>/page/1"
                                   title="users solved this problem">
                                    <s:property value="solved" default="0"/></a>&nbsp;<span
                                    style="font-size:11px;color:grey;font-family:verdana,Serif,Arial;"
                                    title="submissions"><sub>/&nbsp;<s:property value="submit"
                                                                                default="0"/></sub></span>
                            </td>
