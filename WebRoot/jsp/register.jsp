...
<head lang="en">
    <base href="<%=basePath%>">
    <title>Register - HBUT Online Judge</title>
                        ...
                        <form id="register" method="post" action="register">
                            <table class="table-form">
                                <tr>
                                    ...
                                    <td class="input"><input id="username" style="width: 250px;" name="username"
                                                             maxlength="30"
                                                             placeholder="Only letters, numbers, dashes or dots"
                                ...
                                <tr class="subscription-row">
                                    ...
                                    <td>
                                        <div class="shiftUp"><span
                                                class="fielderror"><s:fielderror><s:param>username</s:param></s:fielderror></span>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td><input id="password" name="password" style="width: 250px;" maxlength="30"
                                               type="password" placeholder="Minimum of 6 chars" value=""/></td>
                                </tr>
                                <tr class="subscription-row">
                                    <td>&nbsp;</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td><input id="email" name="email" style="width: 250px;"
                                               placeholder="Your e-mail address" value="<s:property value="email"/>"/>
                                    </td>
                                </tr>
                                <tr class="subscription-row">
                                    <td>&nbsp;</td>
                                    <td align="left">
                                        <div class="shiftUp"><span
                                                class="fielderror"><s:fielderror><s:param>email</s:param></s:fielderror></span>
                                        </div>
                                    </td>
                                </tr>
                                <!--
			              ...
			              -->
                                <tr>
                                    <td align="center" colspan="2"><input id="sub" type="Submit" style="width: 86px;"
                                                                          value="<s:text name="register"/>"/></td>
                                </tr>
                            </table>
                        </form>
                    </div>
