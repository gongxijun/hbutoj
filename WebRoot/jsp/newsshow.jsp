...
<head>
    <base href="<%=basePath%>">
    <title>News - <s:property value="news.title"/> - HBUT Online Judge</title>
...
<div id="body">
    ...
    <div id="content" class="content-with-sidebar round0123">
        ...
        <div class="topic">
            ...
            <div class="info">
                <b>Post by <b><a href="profile/<s:property value="news.create_user"/>" class="user-tip"
                                 user="<s:property value="news.create_user"/>"><s:property
                        value="news.create_user"/></a></b> at <s:date name="news.date" nice="false"
