        ...
        <div id="RecentBlogs">
            ...
            <ul class='BlogList'>
                ...
                <s:iterator value="messages" status="st">
                    <li>
                        <a href="profile/<s:property value="author"/>" class='u user-tip'
                           user="<s:property value="author"/>"><img
                                src="<s:if test="avatar==\"Y\"">upload/userphoto/<s:property value="author"/>/</s:if><s:else>img/</s:else>photo_50.jpg"
                                alt="<s:property value="author"/>"/></a>

                        <div class='b'>
                            <h3><a href="topic/<s:property value="messageId"/>"
                                   style="<s:if test="orderNum>0">color:red</s:if>"><s:property value="title"/></a></h3>
                            ...
                            <div class="buttom">
                                <div class="opts">
                                    ...
                                    <a href="topic/<s:property value="messageId"/>#comments"><s:text
                                            name="topic.reply"/>(<s:property value="comments"/>)</a></div>

                                <div class='date'><s:property value="author"/> <s:text name="post"/> <span
                                        title="<s:date name="in_date" nice="false" format="yyyy-MM-dd HH:mm:ss"/>"><s:property
                                        value="friendly_Date"/></span>
                                    <s:if test="lastReplyUser!=null">
                                        &nbsp;,&nbsp;<s:text name="topic.lastreply"/>(<span title="<s:date
                                            name="lastReplyDate" nice="false"
                                            format="yyyy-MM-dd HH:mm:ss"/>"><s:property
                                            value="lastReplyFriendlyDate"/></span>):<a href="topic/<s:property
                                            value="messageId"/>#rpl_<s:property value="lastReplyId"/>"><s:property
                                            value="lastReplyUser"/>&gt;&gt; </a>
                                    </s:if>
                                </div>
                            </div>
                        </div>
            ...
            <div style="margin:0 12px;font-size:15px;">
                ...
                <div class="right">
                    <s:if test="page>1">
                        <a href="topic/page/<s:property value="page-1"/><s:if test="order!=null">?ORDER=<s:property value="order"/></s:if>"
