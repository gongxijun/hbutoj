...
<head>
    <base href="<%=basePath%>">
    <title>Standings - HBUT Online Judge</title>
...
<div id="body">
    ...
    <div id="content" class="content-with-sidebar">     <!-- class="content-with-sidebar" -->
                ...
                <table class="standings">
                    ...
                    <s:iterator value="usersList" status="st">
                        <tr class="<s:if test="#st.odd">dark</s:if>">
                            <td class="rank left-item <s:if test="#session.session_username==username">my</s:if>">
                                <s:property value="(page-1)*pageSize+#st.index+1"/></td>
                            <td class="coder <s:if test="#session.session_username==username">my</s:if>">
                                <b><a href="profile/<s:property value="username"/>" class="user-tip"
        ...
        <div style="margin-right: 12px;font-size:15px;">
            ...
            <div class="right">
                <s:if test="page>1">
                    <a href="problemset/standings/page/<s:property value="page-1"/>"
