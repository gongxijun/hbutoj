...
<div id="body">
    ...
    <div id="content" class="content-with-sidebar">     <!-- class="content-with-sidebar" -->
                ...
                <table class="mails">
                    ...
                    <s:iterator value="mailList" status="st">
                        <tr <s:if test="#st.odd">class="dark"</s:if>>
                            <td class="status left-item "><s:if test="isnew==1"><img title="never read" alt="never read"
                                                                                     src="img/mail_new.gif" width=16
                                                                                     height=16></s:if><s:else><img
                                    title="readed" alt="readed" src="img/mail_old.gif" width=16 height=16></s:else></td>
                            <td class="title">
                            ...
                            <td class="date" title=""><s:date name="create_date" nice="false"
        ...
        <div style="margin:0 12px;font-size:15px;">
            ...
            <div class="right">
                <s:if test="page>1">
                    <a href="mails/send/page/<s:property value="page-1"/>"
