                    ...
                    <form action="" method="post">
                        ...
                        <div style="text-align:left;margin-bottom: 6px;">
                            ...
                            <input class="message-title" id="message-title" name="title1" maxlength="50"
                                   value="<s:property value="message.title"/>">

                            <textarea class="message-content" id="edit-topic-content" name="content"
                                      rows="20"><s:property value="message.content"/></textarea>
