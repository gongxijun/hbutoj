...
//$(".t_c1").mouseout(function(){$(".t_c1_box").hide();$(".t_c1").removeClass("on");});
        ...
        <ul class="hleft">
            ...
            <li class="t_c_problemset">
                <a href="problemset"><s:text name="problemset"/><img src="img/t_c_bg.gif"/></a>
        ...
        <ul class="hright">
            ...
            <li class="t_cprofile"><a href="profile/<s:property value="#session.session_username"/>"><s:property
                    value="#session.session_username"/><img src="img/t_c_bg.gif"/></a>
                <ul class="t_c2_box t_cprofile_box" style="display:none;">
                    <li><a href="profile/<s:property value="#session.session_username"/>"><s:text name="account"/></a>
                    </li>
