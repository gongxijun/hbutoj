...
<div id="body">
    ...
    <div id="content" class="content-with-sidebar round0123">
        ...
        <div class="topic">
            <div>
                <div class="comment round_0123 highlight mail-edit-box mail-edit-box-pro"
                    ...
                    <form action="" method="post">
                        ...
                        <div style="text-align:left;margin-bottom: 6px;">
                            ...
                            <textarea class="message-content" id="news-content" name="content" rows="20"><s:property
                            ...
                            <select id="defunct" style="width:60px" name="defunct1">
                                <option value="N" <s:if test="news.defunct==\"N\"">selected="selected"</s:if>>No
                                </option>
                                <option value="Y" <s:if test="news.defunct==\"Y\"">selected="selected"</s:if>>Yes
                                </option>
                            </select>
