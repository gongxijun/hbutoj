                ...
                <s:form id="addproblem" method="post" action="addproblem.action" theme="simple" namespace="admin">
                    <div style="padding:6px;">
                        ...
                        <center>Secial Judge
                            ...
                            <br/>
                            Time Limit(MS):<input id="time_limit" name="problem.time_limit" style="width: 48px;"
                                                  value="<s:property value="problem.time_limit" default="1000"/>"/>&nbsp;&nbsp;Memory
                            Limit(KB):<input id="memory_limit" name="problem.memory_limit" style="width: 48px;"
                                             value="<s:property value="problem.memory_limit" default="65535"/>"/><br/>
                        </center>
                        <h5>
                            Title:
                        </h5>
                        ...
                        <div class="add-tags" style="text-align:left;">
                            ...
                            <div style=";text-align: left;margin-left:1em;vertical-align:top;font-size:smaller;">
                         	<span style="">Enter a letter,we may suggest some tags.At most 5 tags is allowed. Tag examples: "水题", "math".
                         	</span>
                            </div>
                            <br/>
