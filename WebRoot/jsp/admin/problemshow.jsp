    ...
    <div id="sidebar">
        <div class="sidebox roundbox">
            ...
            <div class="" style="margin: 6px;font-size: 12px;">
                Solved user(s):<a
                    href="admin/problemset/status/problem/<s:property value="problem.problem_id" default="0"/>/page/1"><s:property
        ...
        <div class="sidebox roundbox">
            ...
            <div class="tools-box" style="margin: 6px;color: #000;">
                <ul>
                    ...
                    <li style="list-style: circle;"><a
                            href="admin/problemEdit.action?problemId=<s:property value="problem.problem_id"/>">Edit</a>
                    </li>
