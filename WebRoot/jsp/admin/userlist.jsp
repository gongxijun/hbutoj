...
<div id="body">
    <div id="content">     <!-- class="content-with-sidebar" -->
                        ...
                        <tr class="<s:if test="#st.odd">dark</s:if> <s:if test="#session.session_username==username">my</s:if>">
                            ...
                            <td class="coder">
                                ...
                                <div style="font-size:11px;padding-top:1px;text-align:left;color: grey;">
                                    <s:property value="nickname"/>,<s:property value="school"/>,Email:<a
                                        href="mails/new/<s:property value="username"/>"><s:property value="email"/></a>
                                </div>
                            </td>
                            <td class="motto"><s:property value="motto"/></td>
                            <td class="">
                                <a href="problemset/status/with/<s:property value="username"/>/page/1"><s:property
                                        value="solved"/></a>
                                /<a href="problemset/status/with/<s:property value="username"/>/page/1"><s:property
                                    value="submit"/></a>
                            </td>
        ...
        <div style="margin-right: 12px;font-size:15px;">
            ...
            <div class="right">
                <s:if test="page>1">
                    <a href="admin/user/page/<s:property value="page-1"/>"
