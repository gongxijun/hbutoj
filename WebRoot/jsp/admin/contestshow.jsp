    ...
    <div id="sidebar">
        ...
        <div class="sidebox roundbox">
            ...
            <div class="tools-box" style="margin: 6px;color: #000;">
                <b><a href="admin/contestEdit.action?contestId=<s:property value="contest.contest_id"/>">Edit
                    Contest</a></b>
                <br/><b><a href="admin/reJudge?contestId=<s:property value="contest.contest_id"/>" class="re-judge">ReJudge
                Contest</a></b>
            </div>
        </div>
                ...
                <div class="innertable" style="position: relative;">
                    ...
                    <table class="problem">
                        <tr class="header">
                            ...
                            <s:if test="contest.type==1">
                                <th class="point"><s:text name="point"/></th>
                            </s:if>
                            <th class=""></th>
                        </tr>
                        <s:if test="cproblemList.size==0">
                            <tr>
                                <td class="left-item dark" colspan="5" style="text-align: left;">There is no records.
                                </td>
                            </tr>
                        </s:if>
                        <s:iterator value="cproblemList" status="st">
                            <tr
                                    <s:if test="#st.odd">class="dark"</s:if> id="tr<s:property value="num"/>">
                                <td class="id left-item"><a
                                        href="contest/<s:property value="contestId"/>/problem/<s:property value="num"/>"><s:property
                                        value="num"/></a></td>
                                <td class="title" style="text-align: left;word-wrap:break-word;">
                                    <div style="float:left;">
                                        <a href="admin/problemset/problem/<s:property value="problemList[#st.index].problem_id"/>"><s:property
                                                value="problemList[#st.index].problem_id"/>. <s:property
                                                value="problemList[#st.index].title"/></a>
                                    </div>
                                    <div style="float:right;font-size:11px;padding-top:1px;text-align:right;color: grey;">
                                        <a href="contest/<s:property value="contestId"/>/problem/<s:property value="num"/>"><s:property
                                                value="title"/></a>
                                    </div>
                                </td>
                                <s:if test="contest.type==1">
                                    <td class="point"><s:property value="point"/>pt</td>
                                </s:if>
                                <td class=""><a
                                        href="admin/contestProblemDelete.action?num=<s:property value="num"/>&contestId=<s:property value="contest.contest_id"/>"
                                        class="problem-delete" num="<s:property value="num"/>"
                                        contestId="<s:property value="contest.contest_id"/>">Delete</a>
                                    |<a href="admin/reJudge?problemId=<s:property value="problemList[#st.index].problem_id"/>&contestId=<s:property value="contest.contest_id"/>"
                                        class="re-judge">ReJudge</a>
                                </td>
                            </tr>
                        </s:iterator>
                        <tr>
                            <s:form action="contestaddproblem" theme="simple" namespace="admin">
                                <td class="id left-item">
                                    ...
                                    <input type="hidden" name="problem.contest_id"
                                           value="<s:property value="contestId"/>"/>
                                </td>
                                <td class="title" style="text-align: left;word-wrap:break-word;">
                                    <div class="add-problem" style="float:left;">
                                        <input type="text" style="width: 68px; height: 18px;" name="problem.problem_id"
                                               placeholder="PID">(Problem ID. or Title)
                                    </div>
                                    <div style="float:right;font-size:11px;padding-top:1px;text-align:right;">
                                        <input type="text" style="width: 228px;" name="problem.title"
                                               placeholder="Title display at contest."
                                               value="Problem <s:property value="index"/>">
                                    </div>
                                </td>
                                <s:if test="contest.type==0"><input type="hidden" style="width: 50px;"
                                                                    name="problem.point" value="1"></s:if>
                                <s:elseif test="contest.type==1">
                                    <td class="point"><input type="text" style="width: 50px;" name="problem.point"
                                                             placeholder="ppts" value="1"></td>
                                </s:elseif>
                                <td class="ratio">
