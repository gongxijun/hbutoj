...
<div id="body">
    ...
    <div id="content">     <!-- class="content-with-sidebar" -->
                ...
                <table class="status">
                    ...
                    <s:iterator value="solutionList" status="st">
                        <tr class="<s:if test="#st.odd">dark</s:if>">
                            <td class="left-item"><b><a class="re-judge"
                                                        href="admin/rejudge/status/<s:property value="solution_id" default="0"/>"
                                                        title="Re-Judge this submission">ReJudge</a></b></td>
                            <td class="id">
                                <a solutionId="<s:property value="solution_id" default="0"/>" class="viewSource"
                                   href="admin/view-source/<s:property value="solution_id" default="0"/>" title="source"
                            ...
                            <td class="coder"><b><a
                                    href="profile/<s:property value="username" default="0"/>"><s:property
                                    value="username" default="Unknown"/></a></b></td>
                            <td class="title">
                                <a href="admin/problemset/problem/<s:property value="problem_id"/>"><s:property
                                        value="problem_id" default="0"/>.<s:property value="problemTitle[#st.index]"
                                                                                     default="Unknow"/></a>
                            </td>
                            <td class="language" title="<s:property value="code_length" default="0"/> B"><s:property
	            		...
	            		"
                                ...
                                <s:else>
                                    ...
                                    <s:elseif test="solutionList[#st.index].verdict==4">
                                        <s:if test="testcase>0"><span>on test <s:property value="testcase"
                                                                                          default="1"/></span>
                                        </s:if>
                                    </s:elseif>
        ...
        <div style="margin-right: 12px;font-size:15px;">
            ...
            <div class="right">
                <s:if test="page>1">
                    <a href="admin/problemset/status<s:if test="problemId!=null">/problem/<s:property value="problemId"/></s:if><s:if test="username!=null">/with/<s:property value="username"/></s:if>/page/<s:property value="page-1"/>"
                ...
                <s:iterator value="pageList" status="st_page">
                    ...
                    <s:else><a
                            href="admin/problemset/status<s:if test="problemId!=null">/problem/<s:property value="problemId"/></s:if><s:if test="username!=null">/with/<s:property value="username"/></s:if>/page/<s:property/>"
