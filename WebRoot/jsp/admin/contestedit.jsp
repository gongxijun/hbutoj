        ...
        <div class="content round_0123" style="background-color:#EEE0E5;padding:3px 3px 3px 3px;">
            <div class="datatable round_0123" style="background-color:#FFF;word-wrap:break-word;">
                <s:form id="contestUpdate" method="post" action="contestUpdate.action" theme="simple">
                    <input type="hidden" id="id" name="contest.contest_id" style="width: 100%;"
                           value="<s:property value="contest.contest_id"/>"/>
                    ...
                    <div style="padding:6px;">
                        ...
                        Contest Start Time:<input style="width: 100px" class="start-date" name="start_date"
                                                  readonly="readonly" value=<s:property value="start_date"/>>
                        ...
                        <h5>
                            ...
                            <select id="type" style="width:150px" name="contest.type">
                                <option value="0" <s:if test="contest.type==0">selected="selected"</s:if>>ACM/ICPC
                                </option>
                                <option value="1" <s:if test="contest.type==1">selected="selected"</s:if>>Google Code
                                    Jam
                                </option>
                            </select>
                        </h5>
