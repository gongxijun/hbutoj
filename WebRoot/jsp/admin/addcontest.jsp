            ...
            <div class="datatable round_0123" style="background-color:#FFF;word-wrap:break-word;">
                <s:form id="addcontest" method="post" action="addcontest.action" theme="simple">
                    <div style="padding:6px;">
                        ...
                        <input id="title" name="contest.title" style="width: 100%;"
                               value="<s:property value="contest.title"/>"/>
                        <span class="fielderror"><s:fielderror><s:param>title</s:param></s:fielderror></span>
                        <h5>
                            Description:
                        </h5>
                        <textarea class="" id="ke-editor" name="contest.description" rows="10"
                                  style="width: 100%"><s:property value="contest.description"/></textarea>
                        <br/>
                        Contest Start Time:<input style="width: 100px" class="start-date" name="start_date"
                                                  readonly="readonly" value=
                        <s:property value="start_date"/>>
                        <input style="width: 24px" class="shour" name="shour" value=<s:property value="shour"/>>HH
                        <input style="width: 24px" class="sminute" name="sminute" value=<s:property value="sminute"/>>MM<span
                            class="fielderror"><s:fielderror><s:param>start_date</s:param></s:fielderror></span>
                        <br/>
                        Contest End Time&nbsp;&nbsp;:<input style="width: 100px" class="end-date" name="end_date"
                                                            readonly="readonly" value=<s:property value="end_date"/>>
                        <input style="width: 24px" class="ehour" name="ehour" value=<s:property value="ehour"/>>HH
                        <input style="width: 24px" class="eminute" name="eminute" value=<s:property value="eminute"/>>MM<span
                            class="fielderror"><s:fielderror><s:param>end_date</s:param></s:fielderror></span>
                        <br/>
                        Start Register Time:<input style="width: 100px" class="start-reg-date" name="start_reg_date"
                                                   readonly="readonly" value=<s:property value="start_reg_date"/>>
                        <input style="width: 24px" class="shour_reg" name="shour_reg" value=<s:property
                                value="shour_reg"/>>HH
                        <input style="width: 24px" class="sminute_reg" name="sminute_reg" value=<s:property
                                value="sminute_reg"/>>MM<span
                            class="fielderror"><s:fielderror><s:param>start_reg_date</s:param></s:fielderror></span>
                        <br/>
                        End Register Time&nbsp;&nbsp;:<input style="width: 100px" class="end-reg-date"
                                                             name="end_reg_date" readonly="readonly" value=<s:property
                            value="end_reg_date"/>>
                        <input style="width: 24px" class="ehour_reg" name="ehour_reg" value=<s:property
                                value="ehour_reg"/>>HH
                        <input style="width: 24px" class="eminute_reg" name="eminute_reg" value=<s:property
                                value="eminute_reg"/>>MM<span
                            class="fielderror"><s:fielderror><s:param>end_reg_date</s:param></s:fielderror></span>
                        <h5>
                            Contest Type:
                        ...
                        <input id="password" name="contest.password" style="width: 200px;"
                               value="<s:property value="contest.password"/>"/>
