...
<div id="body">
    ...
    <div id="content" class="content-with-sidebar">     <!-- class="content-with-sidebar" -->
                ...
                <table class="topics">
                    ...
                    <s:iterator value="newsList" status="st">
                        <tr <s:if test="#st.odd">class="dark"</s:if>>
                            ...
                            <td class="title">
                                [<s:property value="orderNum"/>]<a
                                    href="admin/news/<s:property value="news_id"/>"><s:property value="title"/></a>

                            </td>
                            <td class="date"><s:date name="date" nice="false" format="yyyy-MM-dd HH:mm:ss"/></td>
                            <td class="coder"><a href="profile/<s:property value="create_user"/>"><s:property
                                    value="create_user"/></a></td>
        ...
        <div style="margin:0 12px;">
            ...
            <div class="right">
                <s:if test="page>1">
                    <a href="admin/news/page/<s:property value="page-1"/>"
