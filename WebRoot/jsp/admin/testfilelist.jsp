            ...
            <div class="file-list" style="display: none;">
                <div style="float: left;">
                    <s:iterator value="inputFiles" status="st">
                        <a href="admin/showTestFile?problemId=<s:property value="problemId"/>&inputFilesName=<s:property value="name"/>"><s:property
                                value="name"/></a>
                        <br/>
                    </s:iterator>
                </div>
            ...
            <div class="probleminfo" style="margin: 0 auto;">
                <s:iterator value="inputString" status="st">
                    <div class="sample-test">
                        <div class="input">
                            <div class="title">Input<s:property value="#st.index+1"/></div>
                            <div class="sample-input"><s:property value="inputString[#st.index]" escape="false"/></div>
                        </div>
                        <div class="output">
                            <div class="title">Output<s:property value="#st.index+1"/></div>
                            <div class="sample-output"><s:property value="outputString[#st.index]"
                                                                   escape="false"/></div>
                        </div>
                    </div>
                </s:iterator>
