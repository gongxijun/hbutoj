                ...
                <s:form id="problemUpdate" method="post" action="problemUpdate.action" theme="simple">
                    <div style="padding:6px;">
                        ...
                        <center>
                            ...
                            Problem ID.<input id="problem_id" name="problem.problem_id" style="width: 48px;"
                                              value="<s:property value="problem.problem_id"/>"/>
                            Special Judge
                            ...
                            <select id="contest_id" style="width:60px" name="problem.contest_id">
                                <option value="0" <s:if test="problem.contest_id==0">selected="selected"</s:if>>No
                                </option>
                                <option value="1"
                                        <s:if test="problem.contest_id==1">selected="selected"</s:if> >Yes
                                </option>
                            </select>
                            <br/>Time Limit(MS):<input id="time_limit" name="problem.time_limit" style="width: 48px;"
                                                       value="<s:property value="problem.time_limit"/>"/>&nbsp;&nbsp;Memory
                            Limit(KB):<input id="memory_limit" name="problem.memory_limit" style="width: 48px;"
                                             value="<s:property value="problem.memory_limit"/>"/><br/>

                            OJ Name.<input id="oj_name" name="problem.oj_name" style="width: 48px;"
                                           value="<s:property value="problem.oj_name"/>"/>
                            OJ_PID.<input id="oj_pid" name="problem.oj_pid" style="width: 48px;"
                                          value="<s:property value="problem.oj_pid"/>"/>
                            Virtual Judge
                            <select id="isvirtual" style="width:60px" name="problem.isvirtual">
                                <option value="0" <s:if test="problem.isvirtual==0">selected="selected"</s:if>>No
                                </option>
                                <option value="1" <s:if test="problem.isvirtual==1">selected="selected"</s:if>>Yes
                                </option>
                            </select>
                            <br>
                        </center>
                        ...
                        <input id="title" name="problem.title" style="width: 100%;"
                               value="<s:property value="problem.title"/>"/>
                        <h5>
                            Description:
                        </h5>
                        ...
                        <input id="author" name="problem.author" style="width: 100%;"
                               value="<s:property value="problem.author"/>"/>
                        <h5>
                            Tag:
                        </h5>
                        <input id="tag" name="problem.tag" style="width: 100%;"
                               value="<s:property value="problem.tag"/>"/>
                        ...
                        <div class="add-tags" style="text-align:left;">
                            <div style="float: left;width:350px;border-right:4px solid #B9B9B9;padding-right:1em;">
                                <ul style="text-align: left;">
                                    <li>
                                        <s:if test="tagCount==0"><input name="tag1" style="width: 7em;"
                                                                        value=""/></s:if>
                                        <s:iterator value="tags" status="st">
                                            <input name=tag<s:property value="#st.index+1"/> style="width: 7em;"
                                                   value="<s:property />"/>
                                        </s:iterator>
                                    </li>
