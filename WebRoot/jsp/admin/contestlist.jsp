...
<div id="body">
    ...
    <div id="content" class="content-with-sidebar">     <!-- class="content-with-sidebar" -->
                    ...
                    <s:iterator value="contestList" status="st">
                        <tr <s:if test="#st.odd">class="dark"</s:if>>
                            <td class="id left-item">
                                <a href="admin/contest/<s:property value="contest_id"/>"><s:property
                                        value="contest_id"/></a>
                            </td>
                            <td class="title">
                            ...
                            <td class=""><a href="admin/contestEdit?contestId=<s:property value="contest_id"/>">Edit</a>
                                ...
                                <s:if test="defunct==\"N\"">
                                    ...
                                    <a href="admin/resumeContest?contestId=<s:property value="contest_id"/>"
                                       style="color: red;font-weight: bold;">Resume</a>
                                </s:else>
                            </td>
                        </tr>
                    </s:iterator>
        ...
        <div style="margin:0 12px;">
            ...
            <div class="right">
                <s:if test="page>1">
                    <a href="admin/contests/page/<s:property value="page-1"/>"
