...
<div id="body">
    ...
    <div id="content" class="content-with-sidebar">     <!-- class="content-with-sidebar" -->
                ...
                <table class="problem">
                    ...
                    <s:iterator value="problemList" status="st">
                        <tr <s:if test="#st.odd">class="dark"</s:if>>
                            <td class="id left-item"><a href="admin/problemset/problem/<s:property value="problem_id"/>"
                                                        target="_blank"><s:property value="problem_id"/></a></td>
                            <td class="problem">
                                <div style="float:left;">
                                    <a href="admin/problemset/problem/<s:property value="problem_id"/>" target="_blank"><s:property
                                            value="title"/></a>
                                </div>
                            ...
                            <td class="ratio"><a
                                    href="admin/problemEdit.action?problemId=<s:property value="problem_id"/>">Edit</a>|<a
                                    href="admin/problemset/data/<s:property value="problem_id"/>">Data</a>|<a
                                    href="admin/rejudge/problem/<s:property value="problem_id"/>" class="re-judge">ReJudge</a>
                            </td>
                        </tr>
                    </s:iterator>
                </table>
        ...
        <div style="margin:0 12px;">
            ...
            <div class="right">
                <s:if test="page>1">
                    <a href="admin/problemset/page/<s:property value="page-1"/>"
