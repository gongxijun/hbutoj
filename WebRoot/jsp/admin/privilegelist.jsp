                ...
                <table class="standings">
                    ...
                    <s:iterator value="privilegeList" status="st">
                        <tr <s:if test="#st.odd">class="dark"</s:if>>
                            <td class="coder left-item"><b><a href="profile/<s:property value="username"/>"><s:property
                                    value="username"/></a></b></td>
                            <td class="motto">
                                <s:property value="rightstr"/>
                            </td>
                            <td class="rating"><a href="admin/delPrivilege.action?privilegeId=<s:property value="id"/>">Delete</a>
                            </td>
                        </tr>
                    </s:iterator>
                </table>
