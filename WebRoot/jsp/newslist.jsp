...
<head>
    <base href="<%=basePath%>">
    <title>News - HBUT Online Judge</title>
...
<div id="body">
    ...
    <div id="content" class="content-with-sidebar round0123">     <!-- class="content-with-sidebar" -->
            ...
            <div class="innertable" style="position: relative;">
                ...
                <table class="topics">
                    ...
                    <s:if test="newsList.size==0">
                        <tr>
                            <td class="left-item dark" colspan="15" style="text-align: left;">There is no News.</td>
                        </tr>
                    </s:if>
                    <s:iterator value="newsList" status="st">
                        <tr <s:if test="#st.odd">class="dark"</s:if>>
                            ...
                            <td class="coder"><b><a href="profile/<s:property value="create_user"/>" class="user-tip"
                                                    user="<s:property value="create_user"/>"><s:property
                                    value="create_user"/></a></b></td>
        ...
        <div style="margin:0 12px;">
            ...
            <div class="left">
                <s:if test="page>1">
                    <a href="news/page/<s:property value="page-1"/>"
