                        ...
                        <form id="revocer" method="post" action="passwordRecovery">
                            <table class="table-form">
                                ...
                                <tr>
                                    ...
                                    <td class="input"><input id="email" style="width: 250px;" name="email"
                                                             maxlength="30" placeholder="Your registration-email"
                                ...
                                <tr>
                                    <td colspan="2">
                                        <div style="text-align: center;"><input id="sub" type="Submit" value="Revocer"/>
                                        </div>
                                    </td>
                                </tr>
                            </table>
