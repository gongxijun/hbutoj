...
<div id="body">
    ...
    <div id="content" class="content-with-sidebar ">
        ...
        <div style="margin:0 12px;font-size:15px;">
            ...
            <div class="right">
                <s:if test="page>1">
                    <a href="recent-actions/page/<s:property value="page-1"/><s:if test="order!=null">?ORDER=<s:property value="order"/></s:if>"
                ...
                <s:if test="page < pageCount">
                    <a href="recent-actions/page/<s:property value="page+1"/>"
