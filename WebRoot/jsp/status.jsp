...
<head>
    <base href="<%=basePath%>">
    <title>Status - HBUT Online Judge</title>
...
<div id="body">
    <div id="content">     <!-- class="content-with-sidebar" -->
                        ...
                        <tr class="<s:if test="#st.odd">dark</s:if>">
                            <td class="id left-item <s:if test="#session.session_username==username">my</s:if>">
                                <s:if test="isPrivateList[#st.index]==0">
                                    <a solutionId="<s:property value="solution_id" default="0"/>" class="viewSource"
                                       href="view-source/<s:property value="solution_id" default="0"/>" title="source"
                            ...
                            <td class="title">
                                <s:if test="timeOutList[#st.index]==0">
                                    <a href="problemset/problem/<s:property value="problem_id"/>"><s:property
	            		...
	            		"
                                ...
                                <s:if test="solutionList[#st.index].verdict==3">
                                    <a solutionId="<s:property value="solution_id" default="0"/>"
                                       ...
                                       href="view-compileinfo/<s:property value="solution_id" default="0"/>"><s:property
        ...
        <div style="margin-right: 12px;font-size:15px;">
            ...
            <div class="right">
                <s:if test="page>1">
                    <a href="problemset/status<s:if test="problemId!=null">/problem/<s:property value="problemId"/></s:if><s:if test="username!=null">/with/<s:property value="username"/></s:if>/page/<s:property value="page-1"/>"
                ...
                <s:iterator value="pageList" status="st_page">
                    ...
                    <s:else><a
                            href="problemset/status<s:if test="problemId!=null">/problem/<s:property value="problemId"/></s:if><s:if test="username!=null">/with/<s:property value="username"/></s:if>/page/<s:property/>"
