...
<head>
    <base href="<%=basePath%>">
    <title>Contest - Problem - <s:property value="cproblem.num"/>. <s:property value="cproblem.title"/> -HBUT Online
        Judge</title>
    ...
    <div id="sidebar">
        <div class="sidebox roundbox">
            ...
            <div class="" style="margin: 6px;font-size: 12px;">
                Solved user(s):<a
                    href="contest/<s:property value="contestId" default="0"/>/status/problem/<s:property value="cproblem.num" default="0"/>/page/1"><s:property
                    value="cproblem.solved" default="0"/></a>&nbsp;&nbsp;<br/>
                Submit user(s):<a
                    href="contest/<s:property value="contestId" default="0"/>/status/problem/<s:property value="cproblem.num" default="0"/>/page/1"><s:property
                    value="cproblem.submit_user" default="0"/></a><br/>
                Submission(s) :<a
                    href="contest/<s:property value="contestId" default="0"/>/status/problem/<s:property value="cproblem.num" default="0"/>/page/1"><s:property
                    value="cproblem.submit" default="0"/></a><br/>
            </div>
        </div>
        <div class="sidebox roundbox">
            <div class="roundbox-lt">&nbsp;</div>
            ...
            <div class="tools-box" style="margin: 6px;color: #000;">
                <a style="font-size: 12px;color: #000;font-weight: bold;"
                   href="contest/<s:property value="contestId"/>/submit/<s:property value="cproblem.num"/>">Submit</a><br/>
            </div>
        </div>
        <div class="sidebox roundbox">
            <div class="roundbox-lt">&nbsp;</div>
                ...
                <div class="probleminfo" style="padding:0px 12px 12px 0px;">
                    ...
                    <div class="sample-test">
                        <div class="input">
                            ...
                            <div class="sample-input"><s:property value="problem.sample_input" default="null"
                                                                  escape="false"/></div>
                        </div>
                        <div class="output">
                            <div class="title">Output</div>
                            <div class="sample-output"><s:property value="problem.sample_output" default="null"
                                                                   escape="false"/></div>
                        </div>
                    </div>
                    <h5>
