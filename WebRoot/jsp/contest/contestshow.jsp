...
<div id="body">
    ...
    <div id="content" class="content-with-sidebar">     <!-- class="content-with-sidebar" -->
        <div id="nav-content">
            <a href="contest/<s:property value="contest.contest_id"/>" class="current"><s:text
                    name="contestproblems"/></a>
            <a href="contest/<s:property value="contest.contest_id"/>/status"><s:text name="status"/></a>
            <a href="contest/<s:property value="contest.contest_id"/>/standings" target="blank"><s:text
                    name="standings"/></a>
            <s:if test="#session.session_username!=null">
                <a href="contest/<s:property value="contest.contest_id"/>/status/with/<s:property value="#session.session_username"/>/page/1"
                ...
                <div class="innertable" style="position: relative;">
                    ...
                    <table class="problem">
                        ...
                        <s:if test="problemList.size==0">
                            <tr>
                                <td class="left-item dark" colspan="15" style="text-align: left;">There is no records.
                                </td>
                            </tr>
                        </s:if>
                        <s:iterator value="problemList" status="st">
                            <tr <s:if test="#st.odd">class="dark"</s:if>>
                                ...
                                <td class="solved">
                                    <a href="contest/<s:property value="contest.contest_id"/>/status/problem/<s:property value="num"/>/page/1"
                                       title="users solved this problem"><s:property value="solved"
                                                                                     default="0"/></a><span
                                        style="font-size:11px;color:grey;font-family:verdana,Serif,Arial;"
                                        title="submissions"><sub>/<s:property value="submit" default="0"/></sub> </span>
                                </td>
                                <td class="ratio <s:if test="problemStatusList[#st.index]==1">problem-ac</s:if><s:elseif test="problemStatusList[#st.index]==2">problem-failed</s:elseif>">
                                    <a title="submit your code?"
                                       href="contest/<s:property value="contestId"/>/submit/<s:property value="num"/>"
                                       style=""><s:text name="submit"/></a></td>
                            </tr>
                        </s:iterator>
                    </table>
                </div>
