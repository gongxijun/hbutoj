...
<head>
    <base href="<%=basePath%>">
    <title>Contest - Registrants <s:property value="contest.title"/> - HBUT Online Judge</title>
...
<div id="body">
    ...
    <div id="content">     <!-- class="content-with-sidebar" -->
                ...
                <table class="standings">
                    ...
                    <s:iterator value="userList" status="st">
                        <tr style="height: 42px;"
                            ...
                            <td class="coder"><b><a href="profile/<s:property value="username"/>" class="user-tip"
                                                    user="<s:property value="username"/>"><s:property
                                    value="username"/></a></b><s:if
                                    test="#session.session_username==username">&nbsp;<a href="contest/<s:property
                                    value="contestId"/>/UnRegisterContest" title ="UnRegister this contest?"><img src="img/delete.gif"></img></a></s:if>
                            </td>
        ...
        <div style="margin-right: 12px;">
            ...
            <div class="right">
                <s:if test="page>1">
                    <a href="contestRegistrants/<s:property value="contestId"/>/page/<s:property value="page-1"/>"
                       style="color:#000;text-decoration: none;">  &larr; </a>
                </s:if>
                <s:iterator value="pageList" status="st_page">
                    <a href="contestRegistrants/<s:property value="contestId"/>/page/<s:property/>"
