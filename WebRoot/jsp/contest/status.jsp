...
<head>
    <base href="<%=basePath%>">
    <title>Contest - Status - <s:property value="contest.title"/> - HBUT Online Judge</title>
    ...
    <div id="content">     <!-- class="content-with-sidebar" -->
        <div id="nav-content">
            ...
            <s:if test="#session.session_username!=null">
                <a href="contest/<s:property value="contestId"/>/status/with/<s:property value="#session.session_username"/>/page/1"
                   target="blank"><s:text name="mysubmission"/></a>
            </s:if>
        </div>
            ...
            <div class="innertable" style="">
                ...
                <table class="status">
                    ...
                    <s:if test="solutionList.size==0">
                        <tr>
                            <td class="left-item dark" colspan="20" style="text-align: left;">There is no records.</td>
                        </tr>
                    </s:if>
                    <s:iterator value="solutionList" status="st">
                        <tr class="<s:if test="#st.odd">dark</s:if> ">
                            <td class="id left-item <s:if test="#session.session_username==username">my</s:if>"
                                ...
                                <s:if test="isPrivateList[#st.index]==0">
                                    <a solutionId="<s:property value="solution_id" default="0"/>" class="viewSource"
                                       href="view-source/<s:property value="solution_id" default="0"/>" target="_blank"><s:property
                                            value="solution_id" default="0"/></a>
                                </s:if><s:elseif test="#session.session_username==username">
                                <a solutionId="<s:property value="solution_id" default="0"/>" class="viewSource"
                                   href="view-source/<s:property value="solution_id" default="0"/>"
                                   target="_blank"><s:property value="solution_id" default="0"/></a>
                            ...
                            <td class="coder "><b><a href="profile/<s:property value="username" default="0"/>"
                                                     class="rated-user user-unknow"><s:property value="username"
                                                                                                default="Unknown"/></a></b>
                            </td>

                            <td class="title" style="">
                                <a href="contest/<s:property value="contestId"/>/problem/<s:property value="problemList[#st.index].num"/>"><s:property
                                        value="problemList[#st.index].num"/>.<s:property
                                        value="problemList[#st.index].title" default="Unknow"/></a>
                            </td>
                            <td class="language"><s:property
                                    value="%{getText('language'+solutionList[#st.index].language)}"/></td>
	            		...
	            		"
                                ...
                                <s:if test="solutionList[#st.index].verdict==3">
                                    <a solutionId="<s:property value="solution_id" default="0"/>"
                                       class="viewCompileInfo"
                                       href="view-compileinfo/<s:property value="solution_id" default="0"/>"
                                       target="_blank"><s:property
                                            value="%{getText('verdict'+solutionList[#st.index].verdict)}"/></a>
                                </s:if>
                                <s:else>
                                ...
                                <s:if test="timeOutList[#st.index]==1"><span style="color:red"
                                                                             title="Contest is ended."><sup>*</sup></span></s:if>
                            </td>

                            <td class="time" id="time_<s:property value="solution_id" default="0"/>"><s:property
                                    value="time" default="0"/> ms
                            </td>
        ...
        <div style="margin-right: 12px;font-size:15px;">
            ...
            <div class="right">
                <s:if test="page>1">
                    <a href="contest/<s:property value="contestId"/>/status<s:if test="problemId!=null">/problem/<s:property value="problemId"/></s:if><s:if test="username!=null">/with/<s:property value="username"/></s:if>/page/<s:property value="page-1"/>"
                ...
                <s:iterator value="pageList" status="st_page">
                    ...
                    <s:else><a
                            href="contest/<s:property value="contestId"/>/status<s:if test="problemId!=null">/problem/<s:property value="problemId"/></s:if><s:if test="username!=null">/with/<s:property value="username"/></s:if>/page/<s:property/>"
