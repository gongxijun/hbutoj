                    ...
                    <div class="info" style="width:560px;margin: 0px auto;padding:12px 12px 12px 12px;">
                        ...
                        <SELECT style="width:250px" name="num">
                            <s:iterator value="problemList" status="st">
                                <option value="<s:property value="num"/>"
                                        <s:if test="numId==num">selected="selected"</s:if>><s:property
                                        value="num"/>-<s:property value="title"/></option>
                            </s:iterator>
                        </SELECT>
                        <br/>
                        <b>Language:</b>
                        <select id="select_lang" style="width:250px" name="language">
                            ...
                            <option value="<%=LanguageId%>"
                                    <s:if test="language==#request.LanguageId">selected="selected"</s:if>><%=Language %>
                            </option>
                            <%
                                }
                            } catch (Exception e) {
                        ...
                        <textarea id="source" name="source" rows="25" style="width: 100%"><s:property
