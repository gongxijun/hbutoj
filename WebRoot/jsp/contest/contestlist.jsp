...
<head>
    <base href="<%=basePath%>">
    <title>Contests - HBUT Online Judge</title>
...
<div id="body">
    ...
    <div id="content" class="content-with-sidebar">     <!-- class="content-with-sidebar" -->
            ...
            <div class="innertable" style="position: relative;">
                ...
                <table class="contest">
                    ...
                    <s:if test="rpList.size==0">
                        <tr>
                            <td class="left-item dark" colspan="5" style="text-align: left;">There is no records.</td>
                        </tr>
                    </s:if>
                    <s:iterator value="rpList" status="st">
                        <tr <s:if test="#st.odd">class="dark"</s:if>>
                                    ...
                                    <s:if test="#session.session_username!=null">
                                        <s:if test="isRegister==\"Y\"">
                                            ...
                                            <span style="font-size:10px;"><a
                                                    href="contest/<s:property value="contest.contest_id"/>">Enter &raquo;</a></span>
                                        </s:if>
                                        <s:else>
                                            <s:property value="contest.title"/><br/>
                            ...
                            <td class="start"><s:date name="contest.start_time" nice="false"
                                                      format="yyyy-MM-dd HH:mm:ss"/></td>
                            <td class="during"><s:property value="during"/></td>
                            <td class="info"
                                title="From <s:date  name="contest.start_time" nice="false" format="yyyy-MM-dd HH:mm:ss"/> to <s:date  name="contest.end_time" nice="false" format="yyyy-MM-dd HH:mm:ss"/>">

                                <s:if test="status==\"PENDING\"">
                                    <!--<span style="color:green;"><b>Pending</b></span><br/>-->
                                    Before start &nbsp;<span style="color:grey" class="countdown"><span title="<s:property
                                        value="leftTime"/>"><s:property value="leftTime"/></span></span>
                                </s:if>
                                <s:elseif test="status==\"RUNNING\"">
                                    <span style="color:red;"><b>Running</b></span><br/>
                                    <span style=""><a href="contest/<s:property value="contest.contest_id"/>/standings">Current
                                        standings</a></span><br/>
                                    <span style="color:grey" class="countdown"><span
                                            title="<s:property value="leftTime"/>"><s:property value="leftTime"/></span></span>
                                </s:elseif>
                                <s:else><span style="color:grey;"><b>Ended</b></span></s:else>
                            </td>
                            <td class="reg"
                                title="From <s:date  name="contest.start_reg" nice="false" format="yyyy-MM-dd HH:mm:ss"/> to <s:date  name="contest.end_reg" nice="false" format="yyyy-MM-dd HH:mm:ss"/>">
	            		  	<span class="link-to-contest" style="">
		            			<s:if test="regStatus==\"PENDING\"">
                                    Before registration &nbsp;<span style="font-size:10px;color:grey" class="countdown"><span title="<s:property
                                        value="regleftTime"/>"><s:property value="regleftTime"/></span></span></s:if>
		            			<s:elseif test="regStatus==\"RUNNING\"">
                                    <s:if test="#session.session_username!=null">
                                        <s:if test="isRegister==\"Y\""><b><font style="color: red">Register
                                            success</font></b></s:if>
                                        <s:else><b><a href="javascript:void(0)"
                                                      class="reg <s:property value="contest.contest_id"/>">Register
                                            contest&raquo;</a></b></s:else>
                                    </s:if>
                                    <s:else>
                                        <b><a href="javascript:void(0)" class="reg"> Register contest&raquo;</a></b>
                                    </s:else>
                                    <a href="contestRegistrants/<s:property value="contest.contest_id"/>"
                                       title="The num of registrants"><s:property value="registrants"/></a>
                                    <br/>
                                    Registration running &nbsp;<span style="color:grey;" class="countdown"><span title="<s:property
                                        value="regleftTime"/>"><s:property value="regleftTime"/></span></span>
                                </s:elseif>
	            				<s:else>
                                    <a href="contestRegistrants/<s:property value="contest.contest_id"/>"
                                       title="The num of registrants"><s:property value="registrants"/></a>
            ...
            <div class="innertable" style="position: relative;">
                ...
                <table class="contest">
                    ...
                    <s:if test="endedList.size==0">
                        <tr>
                            <td class="left-item dark" colspan="15" style="text-align: left;">There is no records.</td>
                        </tr>
                    </s:if>
                    <s:iterator value="endedList" status="st">
                        <tr <s:if test="#st.odd">class="dark"</s:if>>
                            <td class="title left-item">
                                <a href="contest/<s:property value="contest.contest_id"/>"><s:property
                                        value="contest.title"/></a>
                            </td>
                            <td class="start"><s:date name="contest.start_time" nice="false"
                                                      format="yyyy-MM-dd HH:mm:ss"/></td>
                            <td class="during"><s:property value="during"/></td>
                            <td class="standings"><a href="contest/<s:property value="contest.contest_id"/>/standings">Final
                                standings</a></td>
                            <td class="registrants"><a
                                    href="contestRegistrants/<s:property value="contest.contest_id"/>"><s:property
                                    value="registrants"/></a></td>
                        </tr>
                    </s:iterator>
                </table>
            </div>
        ...
        <div style="margin:0 12px;font-size:15px;">
            ...
            <div class="right">
                <s:if test="page>1">
                    <a href="contests/page/<s:property value="page-1"/>"
...
<script type="text/javascript" src="http://v3.jiathis.com/code/jiathis_r.js?uid=1339907478548202&type=left&amp;move=0"
