...
<div id="body">
    <div id="sidebar">
        <div class="sidebox roundbox">
            ...
            <div class="" style="margin: 6px;font-size: 12px;">
                Solved user(s):<a
                    href="problemset/status/problem/<s:property value="problemId" default="0"/>/page/1"><s:property
                    value="solved" default="0"/></a> &nbsp;&nbsp;<br/>
                Submit user(s):<a
                    href="problemset/status/problem/<s:property value="problemId" default="0"/>/page/1"><s:property
                    value="submitUser" default="0"/></a><br/>
                Submission(s) :<a
                    href="problemset/status/problem/<s:property value="problemId" default="0"/>/page/1"><s:property
                    value="submit" default="0"/></a><br/>
            </div>
        </div>
        <div class="sidebox roundbox">
            <div class="roundbox-lt">&nbsp;</div>
            ...
            <div class="tools-box" style="margin: 6px;color: #000;">
                <a style="font-size: 12px;color: #000;font-weight: bold;"
                   href="problemset/problem/<s:property value="problemId"/>">Back</a>
            </div>
        </div>
    ...
    <div id="content" class="content-with-sidebar">     <!-- class="content-with-sidebar" -->
        ...
        <div class="content" style="border-left:4px solid #B9B9B9;padding:3px 3px 3px 0px;">
            <center><h5><a href="problemset/problem/<s:property value="problemId"/>"
