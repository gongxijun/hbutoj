    ...
    <div id="sidebar">
        ...
        <div class="sidebox roundbox">
            ...
            <div class="" style="margin: 6px;font-size: 12px; font-family:Consolas;">
                Solved user(s):<a
                    href="problemset/status/problem/<s:property value="problem.problem_id" default="0"/>/page/1"><s:property
                    value="problem.solved" default="0"/></a> &nbsp;&nbsp;<br/>
                Submit user(s):<a
                    href="problemset/status/problem/<s:property value="problem.problem_id" default="0"/>/page/1"><s:property
                    value="problem.submit_user" default="0"/></a><br/>
                Submission(s) :<a
                    href="problemset/status/problem/<s:property value="problem.problem_id" default="0"/>/page/1"><s:property
                    value="problem.submit" default="0"/></a><br/>
            </div>
        </div>
        ...
        <div class="sidebox roundbox">
            ...
            <div class="tags" style="margin: 6px;">
                <s:if test="tagsList.size==0"><span style="font: 11px/26px Monaco, monospace;color: #454545;"><s:text
                        name="notags"/></span></s:if>
                <s:else>
        ...
        <div class="sidebox roundbox">
            ...
            <div class="tools-box" style="margin: 6px;color: #000;">
                ...
                <a style="font-size: 12px;color: #000;font-weight: bold;"
                   href="problemset/submit/<s:property value="problem.problem_id"/>">Submit</a><br/>
                <a style="font-size: 12px;color: #000;font-weight: bold;"
                   href="problemset/statistic/<s:property value="problem.problem_id"/>">Statistic</a>
        ...
        <div class="content" style="border-left:4px solid #B9B9B9;padding:3px 3px 3px 0px;">
            <blockquote>
                <div class="data-title">
                    ...
                    <s:if test="problem.spj!=0"><span style="color:red;font-size:11px;"><b>Special
                        Judge</b></span><br></s:if>
                    Time Limit:<s:property value="problem.time_limit"
                                           default="0"/>MS&nbsp;&nbsp;Memory Limit:<s:property
                        value="problem.memory_limit" default="0"/>KB<br/>
                    <s:if test="problem.isvirtual!=0"><span style="color:red;font-size:11px;"><b>This problem will be
                        judged on <s:property value="problem.oj_name"/></b></span><br></s:if>
                </div>
                <div class="probleminfo" style="padding:0px 12px 12px 0px;">
                    ...
                    <div class="sample-test">
                        <div class="input">
                            ...
                            <div class="sample-input"><s:property value="problem.sample_input" default=""
                                                                  escape="false"/></div>
                        </div>
                        <div class="output">
                            <div class="title">Output</div>
                            <div class="sample-output"><s:property value="problem.sample_output" default=""
                                                                   escape="false"/></div>
                        </div>
                    </div>
                    <h5>
