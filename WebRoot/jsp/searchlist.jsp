...
<div id="body">
    ...
    <div id="search_main">
        <p id="s_type">
            <u rel="all"
               <s:if test="type==\"all\"">class="curr" </s:if>
            <s:elseif test="type==null">class="curr"</s:elseif>><s:text name="all"/></u>
                    ...
                    <table class="standings">
                        ...
                        <s:iterator value="userList" status="st">
                            <tr class="<s:if test="#st.odd">dark</s:if> <s:if test="#session.session_username==username">my</s:if>">
                                ...
                                <td class="coder">
                                    <div style="float:left;">
                                        <b><a href="profile/<s:property value="username"/>"><s:property
                                                value="username"/></a></b>
                                    </div>
                                    <div style="float:right;font-size:11px;padding-top:1px;text-align:right;color: grey;">
                                        <s:property value="nickname"/>
                            ...
                            <tr <s:if test="#st.odd">class="dark"</s:if>>
                                ...
                                <td class="problem">
                                    <div style="float:left;">
                                        <a href="problemset/problem/<s:property value="problem_id"/>"><s:property
                                                value="problem_id"/>.<s:property value="title"/></a>
                                    </div>
                                    <div style="float:right;font-size:11px;padding-top:1px;text-align:right;color: grey;">
                                ...
                                <td class="ratio <s:if test="problemStatusList[#st.index]==1">problem-ac</s:if><s:elseif test="problemStatusList[#st.index]==2">problem-failed</s:elseif>">
                                    <a title="submit your code?"
                                       href="problemset/submit/<s:property value="problem_id"/>"
                                       style="color: grey;"><s:text name="submit"/></a></td>
                            </tr>
                        </s:iterator>
                    </table>
                </div>
                    ...
                    <table class="topics">
                        ...
                        <s:iterator value="messageList" status="st">
                            <tr <s:if test="#st.odd">class="dark"</s:if>>
                                ...
                                <td class="author">
                                    <b><a href="profile/<s:property value="create_user"/>"><s:property
                                            value="create_user"/></a></b>
                                </td>
                                <td class="date">
