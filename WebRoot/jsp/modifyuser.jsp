    ...
    <div id="content" class="content-with-sidebar">
        <div id="nav-content" style="">
            <a href="profile/<s:property value="#session.session_username"/>"><s:property
                    value="#session.session_username"/></a>
            <a href="settings" cssClass="current"><s:text name="settings"/></a>
            <a href="problemset/status/with/<s:property value="user.username"/>/page/1" target="blank"><s:text
                    name="mysubmission"/></a>
        </div>
                            ...
                            <div style="margin-left: 6px;width: 368px;">
                                <table class="table-form">
                                    ...
                                    <tr class="subscription-row">
                                        <td>&nbsp;</td>
                                        <td align="left">
                                            <div class="shiftUp"><span
                                                    class="fielderror"><s:fielderror><s:param>user.email</s:param></s:fielderror></span>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr class="subscription-row">
                                        ...
                                        <td align="left">
                                            <div class="shiftUp"><span
                                                    class="fielderror"><s:fielderror><s:param>old_password</s:param></s:fielderror></span>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr class="subscription-row">
                                        ...
                                        <td>
                                            <div class="shiftUp"><span
                                                    class="fielderror"><s:fielderror><s:param>password</s:param></s:fielderror></span>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr class="subscription-row">
                                        ...
                                        <td>
                                            <div class="shiftUp"><span
                                                    class="fielderror"><s:fielderror><s:param>repeat_password</s:param></s:fielderror></span>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="input"><input id="nickname" style="width: 250px;"
                                                                 ...
                                                                 value="<s:property value="user.nickname"/>"/></td>
                                    </tr>
                                    <tr class="subscription-row">
                                        <td>&nbsp;</td>
                                        <td>
                                            <div class="shiftUp"><span
                                                    class="fielderror"><s:fielderror><s:param>user.nickname</s:param></s:fielderror></span>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <select id="opensource" style="width:60px"
                                                                ...
                                                                <option value="N"
                                                                        <s:if test="user.opensource==\"N\"">selected="selected"</s:if>>
                                                                    No
                                                                </option>
                                                                <option value="Y"
                                                                        <s:if test="user.opensource==\"Y\"">selected="selected"</s:if>>
                                                                    Yes
                                                                </option>
                                                            </select>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><select id="select_lang" style="width:250px"
                                                            ...
                                                            <option value="<%=LanguageId%>"
                                                                    <s:if test="user.language==#request.LanguageId">selected="selected"</s:if>><%=Language %>
                                                            </option>
                                                            <%
                                                                }
                                                            } catch (Exception e) {
                                                            %>
                                                            <option value="1"
                                                                    <s:if test="user.language==1">selected="selected"</s:if>>
                                                                MS C++
                                                            </option>
                                                            <option value="2"
                                                                    <s:if test="user.language==2">selected="selected"</s:if>>
                                                                MS C
                                                            </option>
                                                            <option value="3"
                                                                    <s:if test="user.language==3">selected="selected"</s:if>>
                                                                GNU C++
                                                            </option>
                                                            <option value="4"
                                                                    <s:if test="user.language==4">selected="selected"</s:if>>
                                                                GNU C
                                                            </option>
                                                            <option value="5"
                                                                    <s:if test="user.language==5">selected="selected"</s:if>>
                                                                Java
                                                            </option>
                                                            <option value="8"
                                                                    <s:if test="user.language==8">selected="selected"</s:if>>
                                                                Pascal
                                                            </option>
                                                            <% } %>
                                                        </select>
