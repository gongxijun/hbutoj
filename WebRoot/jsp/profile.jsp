    ...
    <div id="content" class="content-with-sidebar">     <!-- class="content-with-sidebar" -->
        ...
        <div class="content " style="">
                    ...
                    <div style="float:right;border:1px solid #B9B9B9;width:260px;min-height:150px;padding:12px;">
                        <div style="min-height:200px;line-height:200px;text-align:center;">
                            <img style="margin:auto;vertical-align:middle;display:inline;"
                                 ...
                                 src="<s:if test="user.avatar==\"Y\"">upload/userphoto/<s:property value="user.username"/>/</s:if><s:else>img/</s:else>photo_250.jpg"/>
                        </div>
                    </div>
                    <div style="word-wrap:break-word;width:350px;">
                        <ul style="padding: 0px;">
                            <li><b><s:property value="user.username"/></b> <a
                                    href="mails/new/<s:property value="user.username"/>"
                                    title="mail to <s:property value="user.username"/>">@<s:property
                                    value="user.username"/></a></li>
                            <li><span style="color:#000">
				   			 		<s:if test="user.nickname==''||user.nickname==null"><s:property
                                            value="user.username"/></s:if><s:else><s:property
                                    value="user.nickname"/></s:else>
				   			 		<s:if test="user.school==null||user.school==''"></s:if><s:else> , <s:property
                            ...
                            <s:if test="#session.session_username==user.username">
                                <li>E-mail: <s:property value="user.email" default="0"/> &nbsp; &nbsp;<span
                                        style="color:grey">(not visible)</span></li>
                                <li>Birthday: <s:date name="user.birthday" nice="false" format="yyyy-MM-dd"/>&nbsp;
                                    &nbsp;<span style="color:grey">(not visible)</span></li>
                            </s:if>
                            <!--
            ...
            <div class="profile roundbox" style="">
                ...
                <div class="roundbox-rb">&nbsp;</div>
                <div class="top-link" style="border-bottom: 1px solid #b9b9b9;">
                    <div class="titled" style="width: 100%">Problem Tried (<s:property value="problemTryList.size"/>)
                    </div>
                </div>
                <div style="padding: 6px;word-wrap:break-word;">
