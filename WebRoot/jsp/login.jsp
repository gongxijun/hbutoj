                        ...
                        <form id="login" method="post" action="login">
                            <table class="table-form">
                                <tr>
                                    ...
                                    <td class="input"><input id="handle" style="width: 250px;" name="handle"
                                                             maxlength="30"
                                                             placeholder="Your username,not your nickname"
                                                             value="<s:property value="handle"/>"/></td>
                                </tr>
                                <tr class="subscription-row">
                                    <td>&nbsp;</td>
                                    <td>
                                        <div class="shiftUp"><span
                                                class="fielderror"><s:fielderror><s:param>handle</s:param></s:fielderror></span>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <div style="text-align: center;"><input id="sub" style="width: 86px;"
                                                                                type="Submit"
                                                                                value="<s:text name="login"/>"/></div>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <div style="text-align: right; margin-bottom: -16px;"><a
                                                href="registration"><s:text name="login.register"/></a> | <a
                                                href="password-recovery"><s:text name="login.recovery"/></a></div>
