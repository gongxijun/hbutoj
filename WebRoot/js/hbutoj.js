...
(function ($) { // Hide the namespace
    ...
    $.extend(Datepick.prototype, {
        ...
        _doKeyDown: function (event) {
            ...
            if ($.datepick._datepickerShowing)
                switch (event.keyCode) {
                    ...
                    case 13:
                        var sel = $('td.' + $.datepick._dayOverClass, inst.dpDiv);
                        if (sel.length == 0)
        ...
        _checkExternalClick: function (event) {
            ...
            if (!$target.parents().andSelf().is('#' + $.datepick._mainDivId) && !$target.hasClass($.datepick.markerClassName) && !$target.parents().andSelf().hasClass($.datepick._triggerClass) &&
        ...
        _getRangeMin: function (inst) {
            return (this._get(inst, 'rangeSelect') && inst.dates[0] && !inst.dates[1] ? inst.dates[0] : null);
        },
